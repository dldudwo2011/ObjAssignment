...
namespace ObjectOrientedAssignment2.TechnicalServices
{
    public class Students
    {
        public bool AddStudent(Student acceptedStudent, string programCode) // parameter, Camel Case
        {
            ...
            MyDataSource.ConnectionString = @"Persist Security Info=False;Database=ylee39;User ID=ylee39;Password=Zheldcjswo8fd87558;server=dev1.baist.ca;";
            MyDataSource.Open();
        ...
        public Student GetStudent(string studentID)
        {
            ...
            {
                ConnectionString = @"Persist Security Info=False;Database=ylee39;User ID=ylee39;Password=Zheldcjswo8fd87558;server=dev1.baist.ca;"
            };
